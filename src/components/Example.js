										...
										<div className="col-span-3 sm:col-span-2">
											...
											<div className="mt-1 flex rounded-md shadow-sm">
												...
												<input
													...
													id="company-website"
													className="focus:ring-cyan-500 focus:border-cyan-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300"
									...
									<div>
										...
										<div className="mt-1">
											<textarea
												...
												name="about"
												rows={3}
												className="shadow-sm focus:ring-cyan-500 focus:border-cyan-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md"
